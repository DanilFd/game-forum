    ...
    return (
        <nav className={styles.nav}>
            <motion.ul
                {...anim}
            >
                <li><NavLink activeClassName={styles.active} onClick={setIsSearchDisable}
                             to="/news/all?page=1">Новости</NavLink></li>
                <li><NavLink activeClassName={styles.active} onClick={setIsSearchDisable}
                             to="/games?page=1">Игры</NavLink></li>
                <li><NavLink activeClassName={styles.active} onClick={setIsSearchDisable}
                             to="/blogs/new?page=1">Блоги</NavLink></li>
